...
function App() {
  ...
  const getHeaderColors = (pathname) => {
    ...
    return colorSchemes[pathname] || {
      textColor: 'text-gray-800 dark:text-gray-200',
      bgColor: 'bg-white dark:bg-gray-900 shadow-md',
  ...
  const HeaderWrapper = () => {
    ...
    // ✅ FIXED (removed undefined setShowLogin)
        ...
        <div className="flex min-h-screen bg-gradient-to-br from-gray-900 via-black to-purple-900 dark:from-black dark:via-gray-900 dark:to-purple-900">
          ...
          <main className="flex-1 lg:ml-64 pt-16 lg:pt-0">
            <Routes>
              ...
              <Route path="/achievements/:category" element={<AchievementCategory user={user} />} />
