...
import InteractiveForm from "./common/InteractiveForm";
  ...
  const postFormFields = [
    {
      ...
      required: true,
      validation: (value) => {
        if (value.trim().length === 0) return 'Post content cannot be empty';
          ...
          <div className="flex-shrink-0 mb-4">
            <div className="flex items-center space-x-3 mb-2">
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-3 px-4 lg:px-6 rounded-lg font-medium hover:from-purple-700 hover:to-purple-900 transition-all flex items-center justify-center space-x-2 whitespace-nowrap shadow-lg hover:shadow-purple-500/25 flex-shrink-0"
              >
