  ...
  export default function ClubManagement({ user }) {
    ...
    useEffect(() => {
      const fetchMembers = async () => {
        try {
          const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/user/club/${clubId}/members`, {
    ...
    const handleAddMember = async () => {
      if (newMemberName && newMemberEmail) {
        try {
          const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/user/club/member/add`, {
            name: newMemberName,
          ...
          const membersRes = await axios.get(`${import.meta.env.VITE_API_URL}/api/user/club/${clubId}/members`, {
            withCredentials: true,
          });
