...
export default function LostFound({ user }) {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await axios.post('${import.meta.env.VITE_API_URL}/api/lostfound/sendMessage', { itemId: selectedItem._id, message: messageText }, { withCredentials: true });
