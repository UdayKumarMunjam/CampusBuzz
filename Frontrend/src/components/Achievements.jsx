...
export default function Achievements({ user }) {
  ...
  return (
    <div className={`p-4 lg:p-8 min-h-screen ${showAddModal ? 'overflow-hidden' : ''}`}>
        ...
        <div className="flex justify-between items-center">
          <div>
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold text-white mb-2">Campus Achievements</h1>
                <p className="text-lg text-purple-200">Celebrating placement success stories and academic excellence</p>
              </div>
            </div>
          </div>
          ...
          {!canManageAchievements && (
            <div className="bg-white/10 backdrop-blur-xl text-purple-200 px-8 py-4 rounded-xl font-semibold flex items-center space-x-3 border border-purple-500/20">
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-purple-500/20 rounded-2xl shadow-2xl p-8">
        <div className="flex items-center space-x-4 mb-6">
          <div className="p-3 bg-purple-500/20 backdrop-blur-sm rounded-xl">
            <Target className="w-8 h-8 text-purple-400" />
          </div>
          <div>
            <h2 className="text-3xl font-bold text-white">Placement Achievements</h2>
            <p className="text-purple-200">Career success and job placements</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-purple-200 text-lg">No placement achievements yet</p>
            {canManageAchievements && (
              <p className="text-purple-300 text-sm mt-2">Add the first achievement to get started</p>
            )}
          </div>
        )}
      </div>
