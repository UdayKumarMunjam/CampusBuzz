...
export default function UserProfile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 lg:p-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Profile Header */}
        <div className="bg-white/10 backdrop-blur-xl border border-purple-500/20 rounded-2xl shadow-2xl overflow-hidden mb-8">
            ...
            <div className="flex flex-col items-center lg:items-start relative">
              <div className="relative">
                <img
                  ...
                  alt={user.name}
                  className="w-24 h-24 lg:w-32 lg:h-32 rounded-full object-cover border-4 border-purple-400/50 shadow-2xl"
                  onError={(e) => {
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <div className="inline-flex items-center px-3 py-1 bg-purple-500/20 backdrop-blur-sm border border-purple-400/30 rounded-full mb-4">
                ...
                {userId === currentUser._id && (
                  <button
                    ...
                    className="flex items-center space-x-2 bg-purple-600/20 backdrop-blur-sm border border-purple-400/30 text-white px-4 py-2 rounded-xl hover:bg-purple-600/30 hover:border-purple-400/50 transform hover:scale-105 transition-all duration-300 font-medium shadow-lg hover:shadow-xl"
                  >
              ...
              <div className="flex flex-col items-center lg:items-start gap-3 mb-6">
                  <div className="flex space-x-8">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-purple-300 font-medium">Posts</p>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <p className="text-sm text-purple-300 font-medium">Followers</p>
                    </div>
                    <div
                      className="text-center cursor-pointer hover:bg-white/10 rounded-lg p-2 transition-colors"
                    ...
                    >
                      ...
                      <p className="text-sm text-purple-300 font-medium">Following</p>
                    </div>
                  </div>
                  {userId !== currentUser._id && (
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {connectionStatus === 'pending' && (
                          <>
                            ...
                            <span className="text-sm text-yellow-300 font-medium">Connection Pending</span>
                          </>
                        )}
                        {connectionStatus === 'request_received' && (
                          <>
                            <UserPlus size={16} className="text-blue-400" />
                            <span className="text-sm text-blue-300 font-medium">Connection Request Received</span>
                          </>
                        )}
                        {connectionStatus === 'not_connected' && (
                          <span className="text-sm text-purple-300">Not Connected</span>
                        )}
                      </div>
              ...
              {user.bio && (
                <div className="mb-6">
                  <p className="text-purple-100 italic text-sm leading-relaxed">"{user.bio}"</p>
                </div>
              )}
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-purple-200 font-medium text-sm">{user.email}</p>
                </div>
                {user.phone && (
                  <div className="flex items-center space-x-3">
                    <Phone className="w-4 h-4 text-purple-400" />
                    <p className="text-purple-200 font-medium text-sm">{user.phone}</p>
                  </div>
                )}
                {user.location && (
                  <div className="flex items-center space-x-3">
                    <MapPin className="w-4 h-4 text-purple-400" />
                    <p className="text-purple-200 font-medium text-sm">{user.location}</p>
                  </div>
                )}
                <div className="flex items-center space-x-3">
        ...
        {/* User Posts */}
        <div className="bg-white/5 backdrop-blur-sm border border-purple-500/10 rounded-2xl p-6 lg:p-8">
          <div className="flex items-center space-x-4 mb-8">
            <div className="p-3 bg-gradient-to-r from-purple-500 to-purple-700 rounded-xl shadow-lg">
