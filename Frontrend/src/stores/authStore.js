...
export const useAuthStore = create((set, get) => ({
  ...
  checkAuth: async () => {
    try {
      const res = await axios.get(`${API}/api/user/check`, {
  ...
  updateProfile: async (formData) => {
    try {
      const res = await axios.put(`${API}/api/user/profile`, formData, {
        withCredentials: true,
        headers: {
  ...
  cleanupConnections: async () => {
    try {
      ...
      const res = await axios.post(`${API}/api/user/connections/cleanup`, {}, {
        withCredentials: true,
      });
      console.log("Cleanup result:", res.data);
      toast.success(res.data.message || "Connections cleaned up successfully");
  ...
  resetPassword: async (token, newPassword) => {
    try {
      const res = await axios.post(`${API}/api/user/reset-password`, { token, newPassword });
